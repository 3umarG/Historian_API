package com.example.historian_api.config.filters;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    private  UserDetailsService studentsDetailsService;
    ...
    protected void doFilterInternal(@NonNull HttpServletRequest request,
        ...
        final String userEmail = jwtService.extractPhoneNumber(jwt);

        if (isValidAuthenticationState(userEmail)) {
            UserDetails userDetails = studentsDetailsService.loadUserByUsername(userEmail);
